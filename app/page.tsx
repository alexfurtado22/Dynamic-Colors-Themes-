  ...
  return (
    <main className='grid grid-cols-2 items-center justify-center'>
      <div className='col-span-3 flex items-center justify-between gap-4 holder max-md:flex-col'>
        <div>
          <Image
            ...
            src='/skull2.svg'
            alt='Next.js Logo'
            width={248} // Replace 100 with the desired width
            height={228}
            priority
          />
        </div>
      ...
      <div className='grid-adapt-mixin col-span-3 items-center justify-center holder section @sm:max-md:grid-cols-1'>
        <div className='row-span-3 grid grid-rows-subgrid border-2 border-border p-2 text-center'>
          ...
          <Image
            className='h[500] w-[500] items-center dark:drop-shadow-[0_0_0.3rem_#ffffff70]'
            src='/logo.svg'
            alt='Next.js Logo'
